...
// Sidebar — a faithful shadcn Sidebar block, rehomed as a foundation primitive (it composes
// the package's own Button / Input / Separator / Sheet / Skeleton / Tooltip + the useIsMobile
// hook, never app-local `@/…`). Collapsible desktop rail ⟷ mobile Sheet drawer, cookie-persisted
// open state, and the full menu-part vocabulary a host account/app shell hangs its nav on. Skinned
// by host `--sidebar*` tokens — zero hard-coded color.
